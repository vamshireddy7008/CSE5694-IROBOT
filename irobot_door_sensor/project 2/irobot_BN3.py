...
class IrobotNetwork:  
    def __init__(self):
        self.NetworkSet = {
            ...
            'scanner':   Node('scanner', Normal_Distribtion(40.615, 4, 0.35), ["wheel"]                                ),
            'wheel':     Node('wheel'  , Normal_Distribtion(-0.1, 19, 0.35) , []                                       ),  
            'scanner_b': Node('scanner', Normal_Distribtion(200, 50, 0.35), ["wheel_b"]                              ),
            ...
            'wheel':     Node('wheel'  , Normal_Distribtion(11.35, 0.6, 0.65)     , []                                       ),  
